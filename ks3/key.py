...
class Key(object):
    ...
    def enable_calc_encrypt_md5(self, val):
        """
        enable/disable auto calc file md5 for local encryption upload mod
        :param val: True or False
        :return:
        """
        self.calc_encrypt_md5 = val
